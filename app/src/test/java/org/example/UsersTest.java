...
public class UsersTest {
    ...
    @Test
    public void testGeneratedCaptureDate(){
        int shelfLife = 10;
        LocalDate captureDate = UserCreation.generateCapturedDate(shelfLife);
        assertTrue(captureDate.compareTo(LocalDate.now()) <= 0 && captureDate.compareTo(LocalDate.now().minusDays(shelfLife+1)) >= 0);
    }
